...
<h1 style="color: white; margin-left: 50px; margin-top: 20px;">Добавление книги:</h1>
<body>
<form method="post" action="/add-book">
    ...
    <p><input style="margin-left: 350px;" class="but" type="submit" value="Добавить">
        <a class="but" style="margin-left: 70px" href="/books">Отмена</a></p>
</form>
</body>
</html>
